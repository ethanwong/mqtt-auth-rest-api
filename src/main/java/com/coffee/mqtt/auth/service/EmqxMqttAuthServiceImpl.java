...
@Log4j2
@Configuration
@ConditionalOnProperty(prefix = "com.coffee.mqtt.auth.service",name = "impl",havingValue = "EMQX")
public class EmqxMqttAuthServiceImpl implements MqttAuthService {

    @Override
    public BaseResult auth(String broker, String body) {

        log.info("[EmqxMqttAuthServiceImpl] auth");
